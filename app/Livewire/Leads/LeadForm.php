...
class LeadForm extends Component
{
    ...
    public function mount($lead = null)
    {
        ...
        if ($lead instanceof Lead) {
            ...
            $this->leadId = null;
            // Get the next lead number for new leads
            $this->next_lead_number = Lead::getNextLeadNumber();
        }
    ...
    public function save()
    {
        ...
        try {
            ...
            // If this is a new lead, the lead_number will be auto-generated by the model's booted method
            ...
            if ($this->leadId) {
                ...
                Activity::createFor(
                    ...
                    'note',
                    'Lead Updated',
                    "Lead #{$lead->lead_number} was updated by " . auth()->user()->name,
                    auth()->id(),
                    $lead->branch_id
                );
                ...
                Activity::createFor(
                    ...
                    'note',
                    'Lead Created',
                    "New lead #{$lead->lead_number} was created by " . auth()->user()->name,
                    auth()->id(),
                    $lead->branch_id
                );
    ...
    private function loadLead()
    {
        ...
        $this->lead_number = $lead->lead_number; // Add this line to load lead number
