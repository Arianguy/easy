        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('CRM')" class="grid">
                    ...
                    <flux:navlist.item icon="chart-pie" :href="route('opportunities.index')" :current="request()->routeIs('opportunities.*')" wire:navigate>{{ __('Opportunities') }}</flux:navlist.item>
                    <flux:navlist.item icon="megaphone" :href="route('campaigns.index')" :current="request()->routeIs('campaigns.*')" wire:navigate>{{ __('Campaigns') }}</flux:navlist.item>
